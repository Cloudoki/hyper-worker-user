...
exports.uRecoveryToken = (msg, done) => {
	msg.data.superAdmin = false;
	handlers.generateRecoveryToken(msg, done);
};

exports.uRecoverPassword = (msg, done) => {
	msg.data.superAdmin = false;
	handlers.recoverPassword(msg, done);
};
...
exports.saRecoveryToken = (msg, done) => {
	msg.data.superAdmin = true;
	handlers.generateRecoveryToken(msg, done);
};

exports.saRecoverPassword = (msg, done) => {
	msg.data.superAdmin = true;
	handlers.recoverPassword(msg, done);
};
