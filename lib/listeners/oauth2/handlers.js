...
exports.revokeClient = (msg, done) => {
	methods.revokeClient(msg.data.clientID, msg.data.userID)
		.then((revoked) => {
			done(null, {
...
exports.implicit = (msg, done) => {
	methods.implicit(msg.data.client_id, msg.data.user_id, msg.data.response_type)
		.then((token, expiresIn, redirectURI) => {
			done(null, {
				data: {
